...
The URL list is used to iterate all possible names for the .php file, because they are formatted very inconsistently - e.g. Novice Men Compound might be abbreviated NMC, or MNC, or CMN, etc.
